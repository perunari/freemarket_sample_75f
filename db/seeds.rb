categories=[
           ...
           {level1:"メンズ",level1_children:[
                                               {level2:"トップス",level2_children:["Tシャツ/カットソー(半袖/袖なし)", "Tシャツ/カットソー(七分/長袖)", "シャツポロシャツ", "タンクトップ", "ニット/セーター", "パーカー", "カーディガン", "スウェット", "ジャージ", "ベスト", "その他"]},
                                               ...
                                               {level2:"パンツ",level2_children:["デニム/ジーンズ", "ワークパンツ/カーゴパンツ", "スラックスチノパン", "ショートパンツ", "ペインターパンツ", "サルエルパンツ", "オーバーオール", "その他"]},
                                               ...
                                               {level2:"帽子",level2_children:["キャップハット", "ニットキャップ/ビーニー", "ハンチング/ベレー帽", "キャスケット", "サンバイザー", "その他"]},
           ...
           {level1:"インテリア・住まい・小物",level1_children:[
                                               {level2:"キッチン/食器",level2_children:["食器", "調理器具", "収納/キッチン", "雑貨", "弁当用品", "カトラリー(スプーン等)", "テーブル用品", "容器", "エプロン", "アルコールグッズ", "浄水機", "その他"]},
                                               ...
                                               {level2:"収納家具",level2_children:["リビング収納", "キッチン収納", "玄関/屋外収納", "バス/トイレ収納", "本収納", "本/CD/DVD収納", "洋服タンス/押入れ収納", "電話台/ファックス台", "ドレッサー/鏡台棚/ラック", "ケース/ボックス", "その他"]},
           ...
           {level1:"おもちゃ・ホビー・グッズ",level1_children:[
                                               {level2:"おもちゃ",level2_children:["キャラクターグッズ", "ぬいぐるみ", "小物/アクセサリー", "模型/プラモデル", "ミニカートイ", "ラジコン", "プラモデル", "ホビーラジコン", "鉄道模型", "その他"]},
           ...
           {level1:"コスメ・香水・美容",level1_children:[
                                               ...
                                               {level2:"メイクアップ",level2_children:["アイシャドウ", "口紅", "リップ", "グロス", "リップライナー", "チーク", "フェイスカラー", "マスカラ", "アイライナー", "つけまつげ", "アイブロウペンシル", "パウダーアイブロウ", "眉マスカラ", "トライアルセット/サンプル", "メイク道具/化粧小物", "美顔用品/美顔ローラー", "その他"]},
           ...
           {level1:"家電・スマホ・カメラ",level1_children:[
                                               {level2:"スマートフォン/化粧品",level2_children:["スマートフォン本体", "バッテリー/充電器", "携帯電話本体", "PHS本体", "その他"]},
           ...
           {level1:"スポーツ・レジャー",level1_children:[
                                               {level2:"ゴルフ",level2_children:["クラブウエア(男性用)", "ウエア(女性用)", "バッグ", "シューズ(男性用)", "シューズ(女性用)", "アクセサリー", "その他"]},
                                               ...
                                               {level2:"スキー",level2_children:["板ブーツ(男性用)", "ブーツ(女性用)", "ブーツ(子ども用)", "ビンディング", "ウエア(男性用)", "ウエア(女性用)", "ウエア(子ども用)", "ストック", "その他"]},
           ...
           {level1:"ハンドメイド",level1_children:[
                                               {level2:"アクセサリー(女性用)",level2_children:["ピアスイヤリング", "ネックレス", "ブレスレット", "リング", "チャーム", "ヘアゴム", "アンクレット", "その他"]},
                                               ...
                                               {level2:"二次創作物",level2_children:["Ingress", "クリエイターズ宇宙兄弟", "シンデレラガールズCPグッズ"]},
                                               {level2:"その他",level2_children:[""]}
                                              ]
           },
           {level1:"チケット",level1_children:[
                                               ...
                                               {level2:"優待園/割引券",level2_children:["ショッピング", "レストラン/食事券", "フード/ドリンク券", "宿泊券", "その他"]},
                                               {level2:"その他",level2_children:[""]}
                                              ]
           },
